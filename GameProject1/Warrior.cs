...
namespace GameProject1
{
    ...
    public class Warrior
    {
        ...
        public void LoadContent(ContentManager content)
        {
            ...
            bowBody = content.Load<Texture2D>("bow/BODY_animation");
            bowFeet = content.Load<Texture2D>("bow/FEET_shoes_brown");
            bowHead1 = content.Load<Texture2D>("bow/HEAD_chain_armor_hood");
            bowHead2 = content.Load<Texture2D>("bow/HEAD_chain_armor_helmet");
            bowLegs = content.Load<Texture2D>("bow/LEGS_pants_greenish");
            bowTorso1 = content.Load<Texture2D>("bow/TORSO_chain_armor_torso");
            bowTorso2 = content.Load<Texture2D>("bow/TORSO_chain_armor_jacket_purple");
            bowBelt = content.Load<Texture2D>("bow/BELT_leather");
            bowWeapon1 = content.Load<Texture2D>("bow/WEAPON_bow");
            bowWeapon2 = content.Load<Texture2D>("bow/WEAPON_arrow");
